    ...
    return (
        ...
        >
            <div className="flex flex-col gap-7">
                <SectionLabel text={t("about_service")} />
                
                <h2 className={`font-fraktur text-white leading-tight`} style={{ fontSize: "clamp(36px, 5vw, 60px)" }}>
                    {data.title}
                </h2>
            ...
            <div className="grid grid-cols-3 gap-px bg-white/[0.06]">
                {data.stats?.map((s, i) => (
                    <motion.div 
                        ...
                        className="flex flex-col items-center justify-center text-center gap-1.5 py-12 bg-transparent"
                    >
                        <span className={`font-fraktur text-white`} style={{ fontSize: "clamp(32px, 4vw, 52px)" }}>
                            {s.value}
                        </span>
