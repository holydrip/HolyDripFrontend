...
export default function CatalogPage() {
  ...
  return (
    <div className="font-sans flex flex-col w-full min-h-screen pb-24 bg-transparent">
      <motion.div
      ...
      >
        <div className="flex flex-col gap-2">
          <span className="text-white/25 text-[10px] uppercase tracking-[5px] font-light">{t("title")}</span>
