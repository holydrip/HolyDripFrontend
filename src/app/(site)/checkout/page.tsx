      ...
      <main className="p-10">
        ...
        <div className="mt-6 rounded-2xl border border-gray-100 bg-white p-10 text-center shadow-sm">
          ...
          <div className="mt-6 flex justify-center gap-3">
            <a href="/catalog">
              <Button variant="secondary" className="cursor-pointer">Back to catalog</Button>
            </a>
            <a href="/">
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              ...
              <div>
                <div className="text-xs text-gray-600">Telegram Username</div>
                <Input
                  value={tag}
          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
              ...
              {cart.map(({ id, name, price, quantity }) => {
                return (
                  ...
                  >
                    ...
                    <div className="font-medium">{price * quantity} UAH</div>
                  </div>
                );
              })}
            </div>
            ...
            <div className="mt-5 border-t border-gray-100 pt-4">
              <div className="flex items-center justify-between">
                ...
                <div className="text-lg font-semibold">{totalPrice} UAH</div>
              </div>
            </div>
          </div>
        </div>
