...
import { Libre_Baskerville, DM_Sans, UnifrakturMaguntia, Monomakh } from "next/font/google";
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
    return (
        <html lang="en" className="h-full">
            <body suppressHydrationWarning className={`${serif.variable} ${fraktur.variable} ${monomakh.variable} ${dm.variable} font-sans min-h-screen flex flex-col`}>
                <Providers>
                    {children}
                </Providers>
            </body>
