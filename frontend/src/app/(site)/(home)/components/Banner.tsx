    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-8 mt-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-10">
          ...
          >
            <h1
              className={`font-fraktur-en text-white leading-[85%]`}
              style={{ fontSize: "clamp(72px, 13vw, 180px)" }}
            >
              {t("brand_name_line1")}<br />
              <span>{t("brand_name_line2")}</span>
            </h1>
          ...
          >
            <p className={`${cormorant.className} text-white/35 text-xl sm:text-2xl italic sm:text-right leading-relaxed font-light`} dangerouslySetInnerHTML={{ __html: t("motto").replace("\\n", "<br />") }} />
