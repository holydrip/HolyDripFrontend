...
export default function AboutClient() {
    ...
    const slides = [
        { num: "01", title: t("slide_1_title"), text: t("slide_1_text") },
        { num: "02", title: t("slide_2_title"), text: t("slide_2_text") },
        { num: "03", title: t("slide_3_title"), text: t("slide_3_text") },
        { num: "04", title: t("slide_4_title"), text: t("slide_4_text") },
        { num: "05", title: t("slide_5_title"), text: t("slide_5_text") },
        { num: "06", title: t("slide_6_title"), text: t("slide_6_text") },
        { num: "07", title: t("slide_7_title"), text: t("slide_7_text") },
        { num: "08", title: t("slide_8_title"), text: t("slide_8_text") },
    ];
    ...
    return (
        ...
        >
            ...
            >
                <span className="text-white/25 text-[10px] uppercase tracking-[5px] font-light">{t("our_story")}</span>
                <h1 className={`font-fraktur text-white`} style={{ fontSize: "clamp(48px, 8vw, 110px)" }}>
                    {t("title")}
                </h1>
            </motion.div>
            ...
            >
                <div className="flex items-center gap-4 mb-10">
                    <span className={`font-fraktur text-white/60 text-2xl`}>{slides[current].num}</span>
                            ...
                            <div key={i} className="min-w-0 flex-[0_0_100%] sm:flex-[0_0_75%] md:flex-[0_0_55%] pr-6">
                                <div className="flex flex-col gap-8 border-l border-white/10 pl-8 py-4">
                                    <div className="flex flex-col gap-3">
                                        <span className={`font-fraktur text-white/20`} style={{ fontSize: "clamp(48px, 8vw, 96px)", lineHeight: 1 }}>
                                            {slide.num}
                                        </span>
                                        <h2 className={`font-fraktur text-white`} style={{ fontSize: "clamp(28px, 4vw, 52px)" }}>
                                            {slide.title}
                                        </h2>
                                    </div>
            ...
            <div className="px-6 sm:px-12 md:px-[70px] mt-24">
                <div className="w-full h-[1px] bg-white/[0.07]" />
                <p className={`font-fraktur-en text-white/10 mt-8`} style={{ fontSize: "clamp(24px, 4vw, 48px)" }}>
                    {t("footer")}
                </p>
            </div>
        </div>
